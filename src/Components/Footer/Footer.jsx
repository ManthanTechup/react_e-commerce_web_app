            ...
            <div className='container'>
                <div className="row">
                    ...
                    <div className="col-lg-3 col-6">
                        <div className="fw-semibold mb-4">CATALOG</div>
                        <div className='mb-2'>Necklaces</div>
                        <div className='mb-2'>hoodies</div>
                        <div className='mb-2'>Jewelry Box</div>
                        <div className='mb-2'>t-shirt</div>
                        <div className='mb-2'>jacket</div>
                    </div>
                    <div className="col-lg-3 col-6">
                        <div className="fw-semibold mb-4">ABOUT US</div>
                        <div className='mb-2'>Our Producers</div>
                    ...
                    <div className="col-lg-3 col-6">
                        <div className="fw-semibold mb-4">CUSTOMER SERVICES</div>
                        <div className='mb-2'>Contact Us</div>
                        <div className='mb-2'>Track Your Order</div>
                        <div className='mb-2'>Product Care & Repair</div>
                        <div className='mb-2'>Book an Appointment</div>
                        <div className='mb-2'>Shipping & Returns</div>
                    </div>
                </div>
            </div>
